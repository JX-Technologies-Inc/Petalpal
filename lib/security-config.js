...
export function apiDocsEnabled(env = process.env) {
  if (String(env.NODE_ENV || "").toLowerCase() === "production") {
    return String(env.API_DOCS_ENABLED || "").toLowerCase() === "true";
  }
  return String(env.API_DOCS_ENABLED || "true").toLowerCase() === "true";
}
